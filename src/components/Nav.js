...
function Nav() {
  ...
  return (
      <>
        <header
            className="text-white bg-black fixed z-20 top-0 inset-x-0 h-16 justify-between items-center px-16 hidden lg:flex">
          <div className="flex items-center space-x-10">
            ...
            <nav className="font-orb font-medium text-sm uppercase">
              <ul className="flex space-x-7">
                <li>
                  <Link to="/roadmap" className={pathname === '/roadmap' && 'text-primary-light nav-glow'}>
                    roadmap
                  </Link>
                </li>
                <li>
                  <Link to="/mint" className={pathname === '/mint' && 'text-primary-light nav-glow'}>
                    mint
                  </Link>
                </li>
                <li>
                  <Link to="/collection" className={pathname === '/collection' && 'text-primary-light nav-glow'}>
                    collection
                  </Link>
                </li>
                <li>
                  <Link to="/faq" className={pathname === '/faq' && 'text-primary-light nav-glow'}>
                    faq
                  </Link>
                </li>
              </ul>
          ...
          <div className="flex space-x-7 text-2xl">
            <a
                href="https://discord.com/invite/bBeH5"
                target="_blank"
                rel="noreferrer"
            >
